...
class ForumThreadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_thread" do
    assert_difference('ForumThread.count') do
      post forum_threads_url, params: { forum_thread: { forum_id: @forum_thread.forum_id, main_discussion_text: @forum_thread.main_discussion_text, subject: @forum_thread.subject, user_id: @forum_thread.user_id } }
    end
  ...
  test "should update forum_thread" do
    patch forum_thread_url(@forum_thread), params: { forum_thread: { forum_id: @forum_thread.forum_id, main_discussion_text: @forum_thread.main_discussion_text, subject: @forum_thread.subject, user_id: @forum_thread.user_id } }
